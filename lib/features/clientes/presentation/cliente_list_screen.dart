...
class _ClienteListScreenState extends State<ClienteListScreen> {
  ...
  final cliente = clientes[index];
    ...
    final error = await clienteRepo.deleteCliente(cliente.id);
      if (error == null) {
  ...
  final error = await clienteRepo.updateCliente(cliente.id, updated);
      if (error == null) {
        await _fetchClientes();
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  // Si el modelo de cliente tiene email, comparar con email de sesión
                                  return Card(
